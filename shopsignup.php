<html>
     <head>
       ...
       <body class="bg">
          ...
          <div class="container">
                         <br><br><br><h1>Create your Shopkeeping account here to manage everything.</h1><br><br>
                   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="signupstyle">
                         <div class="signup">
						 
                              <form action="shopadminsignup.php" method="POST">
                                  <h1><center>Organization Information</center></h1><br><br>

                                   Shop Address:<br> <input type="text" name="sadd" id="pac-input" placeholder="Shop Address"required><br><br>
                                   ...
                                   Organization to be Sign-uped for:<br>
									...
									$selectSQL1 = "SELECT com_name FROM `company_admin`";
									...
									?>
                                      ...
                                      <br><br>
                                      Enter your City's name:<br><input type="text" name="city" placeholder="Enter your city name."required><br><br>
									  <!--Shop Phone No:<br><input type="number" name="shoppho" placeholder="Enter your Shop Phone No"required><br><br>-->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="signupstyle1">
							...
							Personal Address: <br><input type="text" name="peradd" placeholder="Address."required><br><br>
							...
							<!--Date of Joining: <br><input type="number" name="" placeholder="Date of Join" required><br><br>-->
