     ...
     <head>
       ...
       <body class="bg">
          ...
          <div class="container">
                 ...
                 <br><br><br><center><h1>Create your Organizations account here to manage everything.</h1></center><br><br>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<form action="comadminsignup.php" method="POST">
						<h1><center>Organization Information</center></h1><br><br>
						<div class="signupstyle">
							Organization Name:<br> <input type="text" name="oname" placeholder="Organization Name" required><br><br>
							Organization Contact Number:<br> <input type="number" name="ophone" placeholder="Phone Number" required><br><br>
							Organization Address: <br><input type="text" name="cadd" id="pac-input" placeholder="Company Address"required><br><br>
							Organization Type: <br><input type="text" name="otype" placeholder="Company Type."required><br><br>
							Organization URL: <br><input type="text" name="url" placeholder="Company URL."required><br><br>
							City: <br><input type="text" name="city" placeholder="Bangalore" required><br><br>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="signupstyle1">
							...
							Username:<br> <input type="email" id="uname" name="username" placeholder="abcd1234@something.com" required><br><br>
                            Password:<br> <input type="password" name="password" placeholder="Password" required><br><br>
                            Confirm Password:<br> <input type="password" name="cpassword" placeholder="Confirm Password" required><br><br>
							Phone: <br><input type="number" name="perphono" placeholder="Phone"required><br><br>
							Alternate Email: <br><input type="email" name="altemail" placeholder="Alternate Email."required><br><br>
							Employee ID: <br><input type="text" name="empid" placeholder="Your Emplyoee ID"required><br><br>
							Question: <br><input type="text" name="question" placeholder="Enter you Question here." required><br><br>
							Answer: <br><input type="text" name="answer" placeholder="Answer" required><br><br>
							Gender: <br>
							...
							<!--Date of Joining: <br><input type="date" name="doj" placeholder="Date of Join" required><br><br>-->
							Salary: <br><input type="number" name="salary" placeholder="Salary" required><br><br>
							Experience: <br><input type="number" name="exper" placeholder="Experience" required><br><br>
							Specialization: <br><input type="text" name="special" placeholder="Specialization" required><br><br>
							Address: <br><input type="text" name="peradd" placeholder="Address" required><br><br>
						</div>
					</div>
